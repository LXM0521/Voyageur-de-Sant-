...
function afficherFacture(prenom, nom, actes)
{
    ...
    try{
        ...
        while ((i < patients.length) && (!found)) {
            ...
            var localPrenom = patient.getElementsByTagName("nom")[0].childNodes[0].nodeValue;
            var localNom = patient.getElementsByTagName("prénom")[0].childNodes[0].nodeValue;
        ...
        var visites=xmlDoc.getElementsByTagName("visite");
        var visit=visites[i];
        var acte=visit.getElementsByTagName("acte");
...
function adresseToText(adresse)
{
    ...
    // A complÃ©ter
    var etage="étage :"+adresse.getElementsByTagName("étage")[0].childNodes[0].nodeValue+ "<br/>";
    var numéro="numéro :"+adresse.getElementsByTagName("numéro")[0].childNodes[0].nodeValue+ "<br/>";
    var rue="rue :"+adresse.getElementsByTagName("rue")[0].childNodes[0].nodeValue+ "<br/>";
    var ville="ville :"+adresse.getElementsByTagName("ville")[0].childNodes[0].nodeValue+ "<br/>";
    var codePostal="codePostal :"+adresse.getElementsByTagName("codePostal")[0].childNodes[0].nodeValue+ "<br/>";
